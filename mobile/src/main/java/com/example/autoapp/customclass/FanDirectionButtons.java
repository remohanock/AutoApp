...
public class FanDirectionButtons extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        ImageView directionButton1 = findViewById(R.id.direction_1);
        ImageView directionButton2 = findViewById(R.id.direction_2);
        ImageView directionButton3 = findViewById(R.id.direction_3);
        ImageView directionButton4 = findViewById(R.id.direction_4);
