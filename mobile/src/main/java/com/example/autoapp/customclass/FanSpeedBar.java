...
//        mFanMaxEnabledBgColor = res.getColor(R.color.hvac_fanspeed_segment_color);
        mFanMaxEnabledBgColor = res.getColor(R.color.fan_speed_custom_color);
    }
    ...
    protected void onFinishInflate() {
        ...
        mFanSpeed1 = findViewById(R.id.fan_speed_1);
        mFanSpeed2 = findViewById(R.id.fan_speed_2);
        mFanSpeed3 = findViewById(R.id.fan_speed_3);
        mFanSpeed4 = findViewById(R.id.fan_speed_4);
    ...
    public void setSpeedSegment(int position) {
        for (int i = 0; i < mFanSpeedButtons.size(); i++) {
            ...
            mFanSpeedButtons.get(i).setTurnedOn(i < position);
        }
    }
    /**
