...
import com.example.autoapp.activity.MainActivity;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public void update(
        ...
        notificationBuilder
                ...
                .setColor(
                        mService.getApplication().getResources().getColor(R.color.colorAccent))
        ...
        if (isPlaying && !mStarted) {
            mService.startService(new Intent(mService.getApplicationContext(), MyMusicService.class));
